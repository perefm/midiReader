...
int main()
{
    ...
    do {
        ...
        std::cout << "6. Store events to song (shitty.midi).\n"; 
        std::cout << "7. Load song (shitty.midi): CAUTION: This will delete the stored memory events.\n";
        ...
        case '5':
            ...
            break;
        case '6':
            midiDriver->storeSong("shitty.mid");

            std::cout << "Press any key to get back to menu..." << std::endl;
            std::cin >> no_one_cares;
            break;
        case '7':
            midiDriver->loadSong("shitty.mid");
            std::cout << "Press any key to get back to menu..." << std::endl;
            std::cin >> no_one_cares;
            break;
        case '8':
